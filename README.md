# 从0到1预训练大语言模型
预训练框架：DeepSpeedChat (放弃metaseq，ColossalAI)，github地址：https://github.com/facebookresearch/metaseq<br>
...
No.      |Bug             |     原做法    | 修改           | 注评
 ...
 6 | Calling torch.distributed.barrier() <br>results in the program being killed |#df -lh grep shm<br>shm 64M 0 64M 0% /dev/shm<br>
#rm -f /dev/shm/nccl-* | |Docker容器共享内存太小存满导致，<br>容器里跑训练会遇到，<br>Slurm集群里，面对裸机没有此类问题。
