...
25  | DeepSpeed-Chat | https://github.com/microsoft/DeepSpeed/tree/master/blogs/deepspeed-chat | 指令微调（SFT），Reward model 和强化学习对齐意图（RLHF）
26 | fairseq | https://github.com/facebookresearch/fairseq | FaceBook开源的预训练大语言模型框架
27 | metaseq | https://github.com/facebookresearch/metaseq | FaceBook开源的预训练大语言模型框架，基于fairseq的新版本
