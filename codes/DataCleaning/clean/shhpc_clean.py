...
LawerCleaner = CleanHeadTailsFromContent("utils/law_lowwords.txt",thresh_hold=1)
...
def step1(text):
    ...
    # remove low quality sentences from tails
    cleaned_content = LawerCleaner.backward(cleaned_content)
