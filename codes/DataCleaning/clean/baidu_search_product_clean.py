...
#
_TEXT_LONG_REQUIRED_ = 300

#
_FLUSH_STEPS_NUM_ = 1000

cleaner = GClean(_TEXT_LONG_REQUIRED_)
BaiduCleaner = CleanHeadTailsFromContent("./utils/wechat_ads_phrase.txt",thresh_hold=3)
...
def step1(text):
    ...
    cleaned_content = BaiduCleaner.clean(cleaned_content)
