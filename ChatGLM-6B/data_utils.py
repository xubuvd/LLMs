...
train_info_args = {
    ...
    'model_type': 'chatglm',
    # 预训练模型路径 , 从0训练，则置空
    'model_name_or_path': './pre_models/chatglm/chatglm-6b',
    'config_name': './config/config_small.json',
    'tokenizer_name': './pre_models/chatglm/chatglm-6b',
    'convert_onnx': False, # 转换onnx模型
    'do_train': True,
    'train_file':  [ \
        './data/finetune_train_examples_glm_finetune.json',\
        #'./data/belle_glm_finetune.json',\
        #'./data/alpaca_data_glm_finetune.json',\
        #'./data/alpaca_data_glm_finetune.json',\
        #'./data/alpaca-zh-data-part-00-glm_finetune.json',\
        #'./data/alpaca-zh-data-part-01-glm_finetune.json'
    ],
    'do_eval': True,
    'eval_file': ['./data/trans_chinese_alpaca_data_glm_finetune.json'],
    'do_test': True,
    'test_file': ['./data/trans_chinese_alpaca_data_glm_finetune_testset.json'],
    'max_epochs': 20,
    'max_steps': -1,
