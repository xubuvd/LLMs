...
class Trainer:
    ...
    def _fit_impl(
        ...
        print("trainer-_fit_impl before _run(), ckpt_path={}".format(self.ckpt_path))
    ...
    def _run(
        ...
        if self.state.fn == TrainerFn.FITTING:
            ...
            print("self.fit_loop.min_epochs:",self.fit_loop.min_epochs)
            print("self.fit_loop.max_epochs:",self.fit_loop.max_epochs)
        # clean hparams
        ...
        print("_run, after self._run_stage(), results=",results)
    ...
    def _run_train(self) -> None:
        ...
        with torch.autograd.set_detect_anomaly(self._detect_anomaly):
            print("_run_train in the field of torch.autograd.set_detect_anomaly",flush=True)
            self.fit_loop.run()
