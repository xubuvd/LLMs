...
if __name__ == '__main__':
    ...
    print("data_args.devices:",data_args.devices)
    ...
    if not data_args.convert_onnx:
        ...
        print("trainer.world_size:",trainer.world_size)
        ...
        eval_datasets = dataHelper.load_random_sampler(
        ...
        test_datasets = dataHelper.load_random_sampler(
        ...
        print("checkpoint_callback: ",checkpoint_callback.state_dict())
